...
<div class="bg-blue-50 border border-blue-200 rounded-2xl p-6 mt-8">
  <div class="space-y-4">
    <p class="text-gray-700 text-base leading-relaxed">
      GitStory was a fun build that packed a full product into a buildathon timeline. If you are experimenting with AI-native apps, the fastest way to learn is to ship one end to end.
    </p>
    <p class="text-gray-700 text-base leading-relaxed">
