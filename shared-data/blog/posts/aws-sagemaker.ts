  ...
  <div class="bg-blue-50 border border-blue-200 rounded-2xl p-6 mt-8">
    <div class="space-y-4">
      <p class="text-gray-700 text-base leading-relaxed">
        How are you using AWS SageMaker across the ML lifecycle—training, deployment, or monitoring? Where has it saved you time, and where have you hit friction? Share your experiences and questions to keep the conversation going.
      </p>
      <p class="text-gray-700 text-base leading-relaxed">
