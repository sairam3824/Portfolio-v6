    ...
    <div class="bg-blue-50 border border-blue-200 rounded-2xl p-6 mt-8">
      <div class="space-y-4">
        <p class="text-gray-700 text-base leading-relaxed">
          How are you thinking about data poisoning and model integrity in your AI systems? What defenses have you put in place against corrupted training data? Share your experiences and questions to keep the conversation going.
        </p>
        <p class="text-gray-700 text-base leading-relaxed">
