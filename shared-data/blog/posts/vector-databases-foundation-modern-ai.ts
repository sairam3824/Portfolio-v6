    ...
    <div class="bg-blue-50 border border-blue-200 rounded-2xl p-6 mt-8">
      <div class="space-y-4">
        <p class="text-gray-700 text-base leading-relaxed">
          Which vector database are you using—Pinecone, Chroma, Weaviate, or something else? What's worked well for your embeddings and semantic search workloads? Share your experiences and questions to keep the conversation going.
        </p>
        <p class="text-gray-700 text-base leading-relaxed">
