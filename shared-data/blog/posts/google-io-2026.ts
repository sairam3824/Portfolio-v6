...
<div class="bg-blue-50 border border-blue-200 rounded-2xl p-6 mt-8">
  <div class="space-y-4">
    <p class="text-gray-700 text-base leading-relaxed">
      Google I/O 2026 made one thing clear: the agent stack is now a developer platform. The teams that learn to build on it early will have a real head start.
    </p>
    <p class="text-gray-700 text-base leading-relaxed">
