...
<div class="bg-blue-50 border border-blue-200 rounded-2xl p-6 mt-8">
  <div class="space-y-4">
    <p class="text-gray-700 text-base leading-relaxed">
      Anthropic's pace is not slowing down. The builders who keep up with each release — rather than catching up months later — are the ones compounding their advantage.
    </p>
    <p class="text-gray-700 text-base leading-relaxed">
