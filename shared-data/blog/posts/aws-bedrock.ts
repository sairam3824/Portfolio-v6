      ...
      <div class="bg-blue-50 border border-blue-200 rounded-2xl p-6 mt-8">
        <div class="space-y-4">
          <p class="text-gray-700 text-base leading-relaxed">
            Are you building on Amazon Bedrock, or weighing it against other foundation-model platforms? What's working—and what's getting in the way—as you move generative AI into production? Share your experiences and questions to keep the conversation going.
          </p>
          <p class="text-gray-700 text-base leading-relaxed">
